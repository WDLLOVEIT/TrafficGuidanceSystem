...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		SearchControll.prototype.initialize = function(map){
			...
			$(div).html("<span style='background-color:white;'>输入目的地：</span><input type='text' id='search_input'/><div id='searchResultPanel' style='border:1px solid #C0C0C0;width:150px;height:auto; display:none;'></div>");
